...
@section('content')
  <!-- Section: inner-header -->
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="/images/pastors.jpg">
        <div class="container pt-70 pb-20">
        <!-- Section Content -->
        <div class="section-content">
            <div class="row">
            <div class="col-md-12">
                <h2 class="title text-white text-center">Our Pastors</h2>
                <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="#">Home</a></li>
                <li class="active text-gray-silver">Our Pastors</li>
                </ol>
            </div>
            </div>
        </div>
    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <div class="">
              <img class="img-fullwidth" src="/images/pastors/papa.jpg" alt="">
            </div>
          </div>
          <div class="col-md-8">
        ...
        <div class="container pt-20 pb-70">
            <div class="section-title text-center">
                ...
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="mt-0 line-height-1 text-center text-uppercase mb-10 text-black-333">Pastoral <span class="text-theme-colored"> Team</span></h2>
                    <p>Guiding and Caring for Our Church Community</p>
                </div>
                </div>
            </div>
            <div class="section-content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8">
              <div class="icon-box icon-rounded-bordered left media mb-0 ml-60 ml-sm-0"> <a href="#" class="media-left pull-left flip"> <i class="pe-7s-culture text-white border-1px p-20"></i></a>
                  ...
                  <h3 class="media-heading heading text-white">Embracing God's love</h3>
                  <p class="text-white">Welcome to a digital space where faith comes alive, inspiring you to deepen your relationship with God and others.</p>
                  </div>
              </div>
            </div>
        </div>
    ...
    <section id="branch">
      <div class="container pt-70 pb-70">
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="mt-0 line-height-1 text-uppercase"> Branch  <span class="text-theme-colored">Pastor</span></h2>
              <p>Meet Our Pastors: Guiding Your Spiritual Path</p>
            </div>
          </div>
        </div>
        <div class="section-content">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mt-10 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="maxwidth500 mb-sm-30 border-2px">
                <div class="team-upper-block text-center">
                  ...
                  <h4 class="mt-20 pb-0 mb-0">Pastor Sunny Matthews </h4>
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mt-10 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="maxwidth500 mb-sm-30 border-2px">
                <div class="team-upper-block text-center">
                  ...
                  <h4 class="mt-20 pb-0 mb-0">Pastor Prince Orji </h4>
                </div>
                <div class="team-lower-block text-center pt-0 p-20">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mt-10 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="maxwidth500 mb-sm-30 border-2px">
                <div class="team-upper-block text-center">
                  ...
                  <h4 class="mt-20 pb-0 mb-0">Pastor Elisha Akawu </h4>
                </div>
                <div class="team-lower-block text-center pt-0 p-20">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 mt-10 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="maxwidth500 mb-sm-30 border-2px">
                <div class="team-upper-block text-center">
                  ...
                  <h4 class="mt-20 pb-0 mb-0">Pastor Victor E. Benjamin </h4>
                </div>
                <div class="team-lower-block text-center pt-0 p-20">
