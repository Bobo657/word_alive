                                                                ...
                                                                <td class="pad" style="width: 100%;">
                                                                    <div align="center" class="alignment" style="line-height: 10px;">
                                                                        <img
                                                                            ...
                                                                            src="{{ env('APP_URL') }}/images/animated_header.gif"
                                                            ...
                                                            <tr>
                                                                <td class="pad" style="padding-bottom: 20px; padding-left: 10px; padding-right: 10px; padding-top: 20px; text-align: left;">
                                                                    <div align="left" class="alignment">
                                                                        ...
                                                                        <a
                                                                            href="{{ route('partner.change.password', [
                                                                                'email' => $email,
                                                                                'token' => $token,
                                                                            ]) }}"
                                                                            style="
                                                                        ...
                                                                        >
                                                                            <span style="padding-left: 25px; padding-right: 20px; font-size: 15px; display: inline-block; letter-spacing: normal;">
                                                                                <span style="word-break: break-word;">
                                                                                    <span data-mce-style="" style="line-height: 30px;"><strong>RESET MY PASSWORD</strong></span>
                                                                                </span>
                                                                            </span>
                                                                        </a>
                                                                ...
                                                                <td class="pad" style="width: 100%;">
                                                                    <div align="center" class="alignment" style="line-height: 10px;">
                                                                        <img
                                                                            ...
                                                                            src="{{ env('APP_URL') }}/images/bottom_img.png"
                                                                            style="display: block; height: auto; border: 0; max-width: 600px; width: 100%;"
                                                    ...
                                                    >
                                                                ...
                                                                <td class="pad">
                                                                    <div align="center" class="alignment" style="line-height: 10px;">
                                                                        <a href="/" style="outline: none;" tabindex="-1" target="_blank">
                                                                            <img alt="Your Logo" src="{{ env('APP_URL') }}/images/logo-wide-white.png" style="display: block; height: auto; border: 0; max-width: 195px; width: 100%;" title="Logo" width="195" />
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                <td style="padding: 0 2px 0 2px;">
                                                                                    <a href="{{ config('app.instagram')}}" target="_blank">
                                                                                        <img alt="Instagram" height="32" src="{{ env('APP_URL') }}/images/instagram2x.png" style="display: block; height: auto; border: 0;" title="instagram" width="32" />
                                                                                    </a>
                                                                                </td>
                                                                                <td style="padding: 0 2px 0 2px;">
                                                                                    <a href="{{ config('app.twitter')}}" target="_blank">
                                                                                        <img alt="Twitter" height="32" src="{{ env('APP_URL') }}/images/twitter2x.png" style="display: block; height: auto; border: 0;" title="twitter" width="32" />
                                                                                    </a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                        ...
                                                        >
                                                            <tr>
                                                                <td class="pad">
                                                                    <div
                                                                        style="color: #2c0102; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 120%; text-align: center; mso-line-height-alt: 16.8px;"
                                                                    >
                                                                        <p style="margin: 0; word-break: break-word;">+{{ config('app.phone')}}</p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <td class="pad">
                                                                    ...
                                                                    >
                                                                        <p style="margin: 0; word-break: break-word;">
                                                                            ...
                                                                            Please feel free to contact us at {{ config('app.email')}}.
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div
                                                                        ...
                                                                        "
                                                                    >
                                                                        <p style="margin: 0; word-break: break-word;"><span>Copyright© {{ date('Y')}} {{ config('app.name')}}.</span></p>
                                                                        <p style="margin: 0; word-break: break-word;">
                                                                            <span>
                                                                                 <a href="/privacy_policy" rel="noopener" style="text-decoration: underline; color: #2c0102;" target="_blank" title="Privacy Policy">Privacy Policy</a>
                                                                            </span>
                                                                        </p>
                                                                    </div>
                                                                </td>
