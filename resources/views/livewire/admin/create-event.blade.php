<div class="modal fade" wire:ignore.self id="createEvent" tabindex="-1" aria-labelledby="createEvent" aria-hidden="true">
    <div class="modal-dialog modal-dialog-center">
    <div class="modal-content">
        <div class="modal-header">
        <h1 class="modal-title fs-5" id="createEvent">Create Event Form</h1>
        ...
        <div class="modal-footer">
            ...
            <button wire:click="createEvent()" type="button" class="btn btn-primary">Create Event</button>
        </div>
    </div>
    </div>
</div>